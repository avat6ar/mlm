...
Route::middleware(['admin'])->group(function ()
{
  ...
  Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function ()
  {
    ...
    Route::get('/add', 'addShow')->name('add-show');
  ...
  Route::controller('CodeController')->prefix('code')->name('code.')->group(function ()
  {
    Route::get('/', 'code')->name('index');
    Route::post('save', 'codeSave')->name('save');
    Route::post('delete/{id}', 'delete')->name('delete');
  });

  Route::controller('CourseController')->prefix('course')->name('course.')->group(function ()
  {
