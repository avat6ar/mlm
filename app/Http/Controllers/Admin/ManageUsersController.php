...
class ManageUsersController extends Controller
{
  ...
  public function addShow()
  {
    $pageTitle = 'Add User';
    $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
    return view('admin.users.add', compact('pageTitle', 'countries'));
  }
  ...
  public function add(Request $request)
  {
    ...
    $request->validate([
      ...
      'mobile' => 'required|string|max:40|unique:users,mobile',
      'country' => 'required|in:' . $countries,
    ]);
    ...
    $referUser = User::where('username', $request->referral)->first();
    $position = $request->position;
    $user_position = User::where('username', $request->user_position)->first();
  ...
  public function tree(Request $request, $username = null)
  {
    ...
    if ($user)
    {
      ...
      return view('admin.users.tree', compact('pageTitle', 'tree2', 'tree', 'user'));
    }
