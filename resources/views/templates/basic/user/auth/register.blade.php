          ...
          <div class="row m-0">
            <div class="col-lg-4 p-0">
              <div class="change-catagory-area bg_img"
                data-background="{{ getImage('assets/images/frontend/register/' . @$content->data_values->background_image, '450x970') }}">
            ...
            <div class="col-lg-8 p-0">
              <div class="common-form-style bg-one create-account">
                ...
                <form class="create-account-form row verify-gcaptcha" method="post"
                  ...
                  @if ($refUser == null)
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="form-label">@lang('Username Indirect')</label>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="form-label">@lang('Username Direct')</label>
                      <input class="referral ref_id" name="user_position" type="text" value="{{ old('user_position') }}"
                        autocomplete="off" required>
                      <div id="ref"></div>
                      <span id="referral"></span>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="checkUser" name="code" type="text" value="{{ old('code') }}" required>
                    </div>
                  </div>
