    ...
    @if ($user->kv == 0)
      <div class="alert border--info border" role="alert">
        ...
        <p class="alert__message">
          ...
          <br>
          <small><i>{{ __($kycInfo && kycInfo->data_values->verification_content) }} <a class="link-color"
    ...
    <div class="row g-3 mt-3 mb-4">
      ...
      <div class="col-lg-4">
        <div class="dashboard-widget">
          ...
          <h3 class="text--secondary my-4">{{ showAmount($user->total_binary_com) }} {{ __($general->cur_text) }}
          </h3>
          <div class="widget-lists">
            <div class="row">
              <div class="col-4">
      ...
      <div class="col-lg-4">
        <div class="dashboard-widget">
          <div class="d-flex justify-content-between">
            <h5 class="text-secondary">@lang('Total Indirect')</h5>
          </div>
          <h3 class="text--secondary my-4">{{ showAmount($user->total_binary_com) }}
            {{ __($general->cur_text) }}</h3>
        </div>
      ...
      <div class="col-lg-4">
        <div class="dashboard-widget">
          <div class="d-flex justify-content-between">
            <h5 class="text-secondary">@lang('Total Direct')</h5>
          </div>
